...
/*
	This is how you use the keyword "with test:". Tests are attached to the end of function definitions with some sort of condition. This is a single line test.
	The "using" keyword above is used to create variables that are used in the test condition.
*/
\end{lstlisting}
